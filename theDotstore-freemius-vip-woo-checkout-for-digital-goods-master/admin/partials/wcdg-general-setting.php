...
?>
    <div class="wcdg-main-left-section res-cl">
        ...
        <form method="POST" name="" action="">
            ...
            <table class="form-table wcdg-table-outer product-fee-table">
                ...
                if ( wcfdg_fs()->is__premium_only() ) {
                    ...
                    <?php }else{ ?>
                        ...
                        <td class="forminp mdtooltip">
                            <input type="radio" name="wcdg_chk_on" value="wcdg_down_virtual" <?php checked($wcdg_chk_on, 'wcdg_down_virtual'); ?>> <?php esc_html_e('Quick Checkout for all downloadable and/or virtual products', WCDG_TEXT_DOMAIN); ?><br>
                            <input disabled="disabled" type="radio" name="" value="" class="wcdg_read_only"> <?php esc_html_e('Manually Quick Checkout List for Product/Category/Tag ', WCDG_TEXT_DOMAIN); ?> <label class="pro-version"><?php esc_html_e('In Pro Version', WCDG_TEXT_DOMAIN); ?></label><br>
                        </td>
                    </tr>
                    <?php }
                }else{ ?>
                ...
                if (wcfdg_fs()->is__premium_only() ) {
                    if ( wcfdg_fs()->can_use_premium_code() ) { ?>   
                        <tr valign="top">
                            <th class="titledesc" scope="row">
                                <label for="perfect_match_title"><?php esc_html_e('Allow to update the billing information on thank you page', WCDG_TEXT_DOMAIN); ?></label></th>
                            <td class="forminp mdtooltip">
                                <label>
                                    <input type="checkbox" name="wcdg_allow_additional_field_update_flag" value="on" <?php echo esc_attr($wcdg_allow_additional_field_update_flag); ?>>
                                </label>
                                <span class="wcdg_tooltip_icon"></span>
                                <p class="wcdg_tooltip_desc description">
                                    <?php esc_html_e('Once this option checked then it will showcase button for the quick update user additional fields information on thank you page', WCDG_TEXT_DOMAIN); ?>
                                </p>
                            </td>
                        </tr>
                        <?php 
                            ...
                            <tr valign="top">
                                <th class="titledesc" scope="row">
                                    <label for="perfect_match_title"><?php esc_html_e('Allow to update the billing information on thank you page', WCDG_TEXT_DOMAIN); ?><label class="pro-version"><?php esc_html_e('In Pro Version', WCDG_TEXT_DOMAIN); ?></label></th>
                                <td class="forminp mdtooltip">
                                    <label>
                                        <input type="checkbox" name="wcdg_allow_additional_field_update_flag" disabled value="on" <?php echo esc_attr($wcdg_allow_additional_field_update_flag); ?> class="wcdg_read_only">
                                    </label>
                                    <span class="wcdg_tooltip_icon"></span>
                                    <p class="wcdg_tooltip_desc description">
                                        <?php esc_html_e('Once this option checked then it will showcase button for the quick update user additional fields information on thank you page', WCDG_TEXT_DOMAIN); ?>
                        ...
                        <tr valign="top">
                            ...
                            <td class="forminp mdtooltip">
                                ...
                                <span class="wcdg_tooltip_icon"></span>
                                <p class="wcdg_tooltip_desc description">
                                    <?php esc_html_e('Once this option checked then it will showcase the button to quick update the user additional billing information on thank you page.', WCDG_TEXT_DOMAIN); ?>
                                </p>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <p class="submit"><input type="submit" name="submit_setting" class="button button-primary button-large" value="<?php echo esc_attr('Save', WCDG_TEXT_DOMAIN); ?>"></p>
        </form>
    </div>
