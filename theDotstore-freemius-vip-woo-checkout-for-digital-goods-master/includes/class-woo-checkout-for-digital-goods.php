...
class Woo_Checkout_For_Digital_Goods {
	...
	public function __construct() {
		...
		add_filter( "{$prefix}plugin_action_links_".WCDG_PLUGIN_BASENAME, array(
			$this,
			'plugin_action_links'
		), 10, 4 );
	}
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-woo-checkout-for-digital-goods-user-feedback.php';
	...
	/**
		...
		public function plugin_action_links( $actions ) {
			...
			$custom_actions = array(
				'configure' => sprintf( '<a href="%s">%s</a>', esc_url( add_query_arg( array( 'page' => 'wcdg-general-setting' ), admin_url( 'admin.php' ) ) ), __( 'Settings', $this->plugin_name ) ),
				'docs'      => sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( 'https://docs.thedotstore.com/collection/165-digital-goods-for-woocommerce-checkout' ), __( 'Docs', $this->plugin_name ) ),
